...
date: 2022-03-03T00:01:08+08:00
lastmod: 2026-07-31T00:00:00+08:00
draft: false
remark: 2021-10-17 - 2022-03-03
description: lecture 2 数据结构
tags:        
  - Acwing算法基础课   
---
...
![单链表](/img/acwing/chapter2/wpsAFC7.tmp.jpg) 
...
![单调队列](/img/acwing/chapter2/1644637721398.png)

![单调队列](/img/acwing/chapter2/1644637738675.png)
...
![Trie树](/img/acwing/chapter2/1644760589784.png)
...
![基本原理](/img/acwing/chapter2/1644832877691.png)
...
- 问题3：如何合并两个集合
  ...
  ![合并集合](/img/acwing/chapter2/1644845624459.png) 
...
>
> ![路径压缩](/img/acwing/chapter2/1644844526239.png)
...
![存储](/img/acwing/chapter2/1644917137772.png)
...
- down(x) {}  往下调   [O(logn)]
  ...
  ![1644917379969](/img/acwing/chapter2/1644917379969.png)

  ![1644917390859](/img/acwing/chapter2/1644917390859.png) 
...
![O(n)建堆](/img/acwing/chapter2/1644933510031.png)
...
1. 拉链法
    ...
    ![拉链法](/img/acwing/chapter2/1646051867837.png)

    操作：

    1. 添加(插入)

       ![插入](/img/acwing/chapter2/1646060882466.png)
...
2. 开放寻址法
    ...
    ![开放寻址法](/img/acwing/chapter2/1646115363520.png)
...
1. 先把每一个前缀的哈希值求出来(字符串 --> 数字)。
   ...
   ![字符串映射](/img/acwing/chapter2/1646119205933.png)
...
2. 利用前缀哈希算出任意子串哈希
   ...
   2. 从 L ~ R 段的哈希值    h[R] - h[L-1] * p^(R-L+1)^
      ...
      ![L~R段哈希值](/img/acwing/chapter2/1646154233456.png)
...
![直方图](/img/acwing/chapter2/19_eac6c46017-2559_1.jpg)
...
![模拟过程](/img/acwing/chapter2/1644674377127.png)
...
![KMP](/img/acwing/chapter2/95860_5b7ce5f648-111801.png) 
...
2. 使用Trie树  O(31) * n(十万) ≈ nlogn
   ...
   ![保存与筛选](/img/acwing/chapter2/1645087093192.png)

   思路：从前往后枚举，先 **插入** 再 **查询** (也可先查询再插入，但开始空要加判断)。

   ​	查询：查询 ai 前面和 ai 异或最大的值。

   ![思路](/img/acwing/chapter2/1645103981023.png)
...
> ![优化过程](/img/acwing/chapter2/1644911891583.png)
>
...
![所给样例](/img/acwing/chapter2/1644911365103.png)
...
![样例图示](/img/acwing/chapter2/1645199664162.png)

**思路**：

并查集中，维护每个点到根节点的 **距离** 。将距离分为三大类：

![三类距离](/img/acwing/chapter2/1645250329339.png)

1. 何为距离，即是 `关于代的关系` ，对 **3** 取模以示之。

  ![关于代的关系](/img/acwing/chapter2/1645250388289.png)

2. 每个点到父节点距离如何维护？

   存的时候存其对父节点距离。在做 **路径压缩** 时，将每个点到 **父节点** 的距离更新成对 **根节点** 的距离。

   ![距离维护](/img/acwing/chapter2/1645250849185.png)
...
5. 存下父节点的根节点；
   ...
   **d[i]：第 i 个节点到其父节点距离** [ref：find()函数调用过程](https://www.acwing.com/solution/content/15938/)
   ...
   ![find函数](/img/acwing/chapter2/41774_bd485030c0-JIE.jpg)
...
- 难点
  ...
  ![交换第k个插入数](/img/acwing/chapter2/1645004854237.png)
...
![回文子串的最大长度](/img/acwing/chapter2/1646209987825.png)
...
![逆序下标转换](/img/acwing/chapter2/1646213451004.png)
